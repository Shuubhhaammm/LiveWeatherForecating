...
const API_KEY = "c6ce040e7688c014e9fbb3f90b1ae4e1";
...
function switchTab(clickedTab){
    if(clickedTab != currentTab)
    {
        ...
        if(!searchForm.classList.contains("active")){
            //is search container in invisible ? then visible it
...
console.log("getfromsessionstroage");
...
console.log("fetchuser weather info");
